...
export default function App() {
  ...
  function onFriendAdding(friend) {
  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        />
        {showAddFriend && <FormAddFriend onFriendAdding={onFriendAdding} />}
...
function FormAddFriend({ onFriendAdding }) {
...
function FormSplitBill({ selectedFriend, onHandleSplit }) {
  ...
  function handleSubmit(e) {
    ...
    onHandleSplit(whoIsPaying === "user" ? friendsExpense : -paidByUser);
  }
  return (
    <form className="form-split-bill" onSubmit={handleSubmit}>
      <h2>Split a bill wihth {selectedFriend.name}</h2>
